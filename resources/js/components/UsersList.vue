	...
	<transition name="fade">
		<div v-if="users.length">
			...
			<ul class="list-group mb-3">
				...
				<li v-if="average !== null" class="list-group-item d-flex justify-content-between px-4 py-2">
					<span>Average</span>
					<strong>{{average}}</strong>
				</li>

				<li v-if="chart" class="list-group-item d-flex justify-content-between px-4 py-2">
